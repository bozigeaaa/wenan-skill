...
Create brand背书 scripts that prove company capability through project scenes and delivery logic. The script should not say "我们很强"; it should let buyers infer reliability from specific, verified capabilities.
...
2. Translate it into a project scene.
   ...
   - Show what goes wrong when responsibility is split across too many parties.
...
- `references/proof-pattern.md`: brand背书 structure and scene logic.
