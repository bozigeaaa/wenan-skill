# Brand Proof Fact Rules

## High-Risk Company Claims

Verify before using:

- Factory area, production capacity, stock quantity, delivery time, install time.
...
- Factory area should use the project-confirmed `15000㎡` only when factory area is relevant.
- If other area or capacity figures appear in materials, treat them as conflict-prone and verify.

## Brand Naming

Use names consistently:

- External Saudi-facing brand: 东方骆驼 / EASTERN CAMEL.
...
- "政府认可", "官方指定", "唯一供应商" unless directly verified.
- "一定能按期交付" or "任何问题当天解决".
- Treating all products as always in stock.
